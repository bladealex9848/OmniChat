...
st.write('Tiene acceso a documentos personalizados y puede responder a las consultas de los usuarios refiriéndose al contenido de esos documentos')
...
class CustomDataChatbot:
    ...
    def main(self):
        ...
        uploaded_files = st.sidebar.file_uploader(label='Cargar archivos PDF', type=['pdf'], accept_multiple_files=True)
