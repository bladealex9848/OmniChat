...
st.write('Permite al chatbot analizar imágenes y responder preguntas sobre ellas usando modelos multimodales gratuitos de OpenRouter.')
...
class MultimodalChatbot:
    ...
    def main(self):
        ...
        if user_query:
            ...
            elif isinstance(user_query, dict) and "files" in user_query and user_query["files"]:
                user_files = user_query["files"]
            ...
            if user_files:
                ...
                st.sidebar.image(image_file, caption="Imagen cargada", use_column_width=True)
            ...
            with st.chat_message("assistant"):
                ...
                if response_stream:
                    ...
                    st.error("No se pudo obtener una respuesta del modelo. Por favor, intenta de nuevo.")
